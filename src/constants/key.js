module.exports = class Key {
    static PROPERTY_OWNER = "propertyOwner";
    static LOT_NUMBER = "lotNumber";
    static STREET_NUMBER = "streetNumber";
    ...
    static DURATION_DATE_TO = "durationDateTo";
    static NAME_PRINTED = "namePrinted";
    static NAME_SIGNATURE = "nameSignature";
}